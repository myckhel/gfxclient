        ...
        return (
            <div>
                <footer className="site-footer">
                    <img src={require("../../../assets/images/shapes/footer-shape-1.png")} className="site-footer__shape-1" alt=""/>
                        <img src={require("../../../assets/images/shapes/footer-shape-2.png")} className="site-footer__shape-2" alt=""/>
                            <img src={require("../../../assets/images/shapes/footer-shape-3.png")} className="site-footer__shape-3" alt=""/>
                    ...
                    <div className="side-menu__block-inner ">
                        <div className="side-menu__top justify-content-end">
                            ...
                            <a href="#" className="side-menu__toggler side-menu__close-btn"><img
                                src={require("../../../assets/images/shapes/close-1-1.png")} alt=""/></a>
                        </div>
