                        ...
                        <div className="col-lg-8">
                            <div className="blog-details__content">
                                <div className="blog-details__image">
                                    <img src={require("../../../assets/images/blog/blog-d-1.jpg")} alt=""/>
                                </div>
                            ...
                            <div className="author-one">
                                <div className="author-one__image">
                                    <img src={require("../../../assets/images/blog/author-1-1.jpg")} alt=""/>
                                </div>
                            ...
                            <div className="comment-one">
                                ...
                                <div className="comment-one__single">
                                    <div className="comment-one__image">
                                        <img src={require("../../../assets/images/blog/comment-1-1.jpg")} alt=""/>
                                    </div>
                                ...
                                <div className="comment-one__single">
                                    <div className="comment-one__image">
                                        <img src={require("../../../assets/images/blog/comment-1-2.jpg")} alt=""/>
                                    </div>
                                    <div className="comment-one__content">
                                        <h3>Jorge Glover</h3>
                                        <div className="comment-one__date">20 Feb, 2020 <span>.</span> 4:00 pm</div>
                            ...
                            <div className="sidebar">
                                ...
                                <div className="sidebar-single sidebar__post">
                                    ...
                                    <div className="sidebar__post-single">
                                        <img src={require("../../../assets/images/blog/lp-1-1.jpg")} alt=""/>
                                            <h3><a href="/blog-details">Pre launch Mobile App Marketing Pitfalls</a>
                                            </h3>
                                    </div>
                                    <div className="sidebar__post-single">
                                        <img src={require("../../../assets/images/blog/lp-1-2.jpg")} alt=""/>
                                            <h3><a href="/blog-details">Pre launch Mobile App Marketing Pitfalls</a>
                                            </h3>
                                    </div>
                                    <div className="sidebar__post-single">
                                        <img src={require("../../../assets/images/blog/lp-1-3.jpg")} alt=""/>
                                            <h3><a href="/blog-details">Pre launch Mobile App Marketing Pitfalls</a>
                                            </h3>
                                    </div>
                                </div>
