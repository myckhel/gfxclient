...
const Faq = () => {
        return (
            ...
            <section className="faq-one">
                <img src={require("../../../assets/images/shapes/faq-shape-1.png")} alt="" className="faq-one__shape-1"/>
                <img src={require("../../../assets/images/shapes/faq-shape-2.png")} alt="" className="faq-one__shape-2"/>
                <img src={require("../../../assets/images/shapes/faq-shape-3.png")} alt="" className="faq-one__shape-3"/>
