    ...
    render() {
        return (
            ...
            <section className="funfact-one">
                <img src={require("../../../assets/images/shapes/pricing-shape-1.png")} alt="" className="funfact-one__shape-1" />
                <img src={require("../../../assets/images/shapes/pricing-shape-2.png")} alt="" className="funfact-one__shape-2" />
                <img src={require("../../../assets/images/shapes/pricing-shape-3.png")} alt="" className="funfact-one__shape-3" />
